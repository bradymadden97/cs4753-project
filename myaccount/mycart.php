	...
	<div class="col-sm-12 col-md-4">
		<div id="checkoutbox">
			...
			<div id="checkoutitemsandprice">
				...
				<hr class="checkouthr">
			<form id="checkoutform" method="POST" action="../checkout/createinvoice.php">
				<input type="image" src="https://test.bitpay.com/img/button-large.png" border="0" id="bitpaycheckoutbtn" alt="BitPay, the easy way to pay with bitcoins." >
			</form>
		</div>	
	</div>
</div>